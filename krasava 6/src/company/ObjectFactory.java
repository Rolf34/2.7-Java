...
public final class ObjectFactory {
    ...
    public static Employee createEmployee(String id, String firstName, String lastName, Department department, Position position, String hireDate, double salary, WorkSchedule schedule) {
        return new company.empoloyees.RegularEmployee(id, firstName, lastName, firstName.toLowerCase()+"."+lastName.toLowerCase()+"@company.com",
    ...
    public static Project createProject(String id, String title, Employee owner) {
